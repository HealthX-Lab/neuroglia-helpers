...
If you want to use a different configuration profile, e.g. `xiaobird` for graham, `xiaoBeluga` for Beluga, and `xiaoNarval` for Narval, add it as an argument to `setup.sh`:
```
